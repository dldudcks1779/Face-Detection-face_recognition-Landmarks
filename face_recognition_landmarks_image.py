...
for face_landmark in face_landmarks :
    ...
    for facial_feature in KEY_FACIAL_FEATURES :
        ...
        for point in face_landmark[facial_feature] :
            # cv2.putText(face_image, str(point_number), (point[0] - 5, point[1] - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 0, 0), 1) # point 번호 출력
            cv2.circle(face_image, (point[0], point[1]), 4, (0, 0, 225), -1) # point 좌표 출력
